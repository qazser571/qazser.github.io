    ...
    if (prevRaw) {
        ...
        if (isSameWordList(prevList, newWords)) {
            ...
            if (prevShuffle === newShuffle) {
                ...
                state.words =
                    newShuffle && prevShuffledList
                        ? prevShuffledList
                        : newWords;

            } else {

                state.words = newShuffle
                    ? shuffleArray(newWords)
                    : newWords;

                sessionStorage.setItem(
                    "memorizeShuffledList",
...
function renderCards() {
    ...
    state.words.forEach(word => {
        ...
        cover.addEventListener("click", () => wrapper.classList.add("open"));
        means.addEventListener("click", () => wrapper.classList.remove("open"));
